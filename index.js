...
client.once("ready", async () => {
    ...
    client.user.setPresence({ activities: [{ name: `maten a towa`, type: ActivityType.Playing }], status: 'online' }) // Set a activity.
});
...
client.on("messageCreate", async message => {
    ...
    try {
        ...
        await message.reply("Hubo un problema al manejar el comando."); // This sends a msg in the discord channel.
    }
